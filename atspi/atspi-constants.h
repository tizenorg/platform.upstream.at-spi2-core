 ...
 * AtspiGestureType
 *
 * @ATSPI_GESTURE_N_FINGERS_LONGPRESS_HOLD:
 * @ATSPI_GESTURE_N_FINGERS_TAP:
 * @ATSPI_GESTURE_N_FINGERS_FLICK:
 * @ATSPI_GESTURE_USER_DEFINED:
 */
typedef enum
{
   ATSPI_GESTURE_N_FINGERS_LONGPRESS_HOLD,
   ATSPI_GESTURE_N_FINGERS_SINGLE_TAP,
   ATSPI_GESTURE_N_FINGERS_DOUBLE_TAP,
   ATSPI_GESTURE_N_FINGERS_TRIPLE_TAP,
   ATSPI_GESTURE_N_FINGERS_FLICK,
   ATSPI_GESTURE_N_FINGERS_FLICK_RETURN,
   ATSPI_GESTURE_LAST_DEFINED
} AtspiGestureType;

/**
 * AtspiGestureDirection
 *
 * @ATSPI_GESTURE_DIRECTION_UNDEFINED,
 * @ATSPI_GESTURE_DIRECTION_LEFT,
 * @ATSPI_GESTURE_DIRECTION_RIGHT,
 * @ATSPI_GESTURE_DIRECTION_UP,
 * @ATSPI_GESTURE_DIRECTION_DOWN,
 * @ATSPI_GESTURE_DIRECTION_LAST_DEFINED
 */
typedef enum
{
   ATSPI_GESTURE_DIRECTION_UNDEFINED,
 ...
 * AtspiGestureState
 *
 * @ATSPI_GESTURE_STATE_BEGIN
 * @ATSPI_GESTURE_STATE_CONTINUED
 * @ATSPI_GESTURE_STATE_ENDED
 * @ATSPI_GESTURE_STATE_ABORTED
 */
typedef enum
{
   ATSPI_GESTURE_STATE_BEGIN     = (1 << 0),
   ATSPI_GESTURE_STATE_CONTINUED = (1 << 1),
   ATSPI_GESTURE_STATE_ENDED     = (1 << 2),
   ATSPI_GESTURE_STATE_ABORTED   = (1 << 3),
} AtspiGestureState;
